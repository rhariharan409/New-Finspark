/**
 * Fraud Timeline Event Generator for Card Not Present (CNP) Transactions
...
export class TimelineGenerator {
  /**
   * Builds step-by-step timeline of security events leading to final AI decision
   */
  public generateFraudTimeline(
    ...
    // Helper to format incremental timestamp strings
    ...
    let decisionTitle = '';
    let decisionSeverity: TimelineEventSeverity = 'LOW';
    let decisionIcon = '✅';
