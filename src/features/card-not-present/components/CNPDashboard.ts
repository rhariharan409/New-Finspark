/**
 * CNP Dashboard Composite View
 * Assembles all sub-components into unified interactive UI view
 */

import { CNPSimulationResponse } from '../services/cnpService.js';
...
export function renderCNPDashboard(
  data: CNPSimulationResponse,
