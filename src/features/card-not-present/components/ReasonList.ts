/**
 * Reason List Component (Explainable AI Panel)
 * Displays dynamic feature weights (+X / -Y) and rationale behind the AI risk decision
 */

import { RiskEvaluationResult } from '../types/cnpTypes.js';

export function renderReasonList(riskResult: RiskEvaluationResult): string {
