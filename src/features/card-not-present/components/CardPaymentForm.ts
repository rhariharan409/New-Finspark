 ...
 * Form to input card number, cardholder name, expiry date, CVV, amount, merchant name, and merchant category.
 */

import { CNPTransaction } from '../types/cnpTypes.js';
import { MERCHANT_CATEGORIES } from '../constants.js';

export function renderCardPaymentForm(transaction: CNPTransaction): string {
  return `
